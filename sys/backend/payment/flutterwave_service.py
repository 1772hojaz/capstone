    ...
    def initialize_payment(self, amount: float, email: str, tx_ref: str, currency: str = "USD", redirect_url: str = None) -> Dict[str, Any]:
        ...
        try:
            payload = {
                ...
                "amount": str(amount),
                "currency": currency,
                "redirect_url": redirect_url or f"{os.getenv('BACKEND_URL', 'https://connectafrica.store')}/api/payment/callback",
    ...
    def initiate_transfer(
        ...
        try:
            payload = {
                ...
                "narration": narration,
                "currency": currency,
                "callback_url": f"{os.getenv('BACKEND_URL', 'https://connectafrica.store')}/api/payment/transfer-callback"
            }
