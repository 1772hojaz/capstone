  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col" role="application">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="px-6 py-4 flex justify-between items-center">
          ...
          >
            ...
            <span className="text-xl font-semibold text-gray-800">ConnectSphere Admin</span>
          </button>

          {/* Right Side - Search, Logout, User */}
          <div className="flex items-center gap-6">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search users, groups, products..."
      ...
      <div className="flex flex-1">
        {/* Sidebar */}
      <aside className="w-64 bg-white border-r border-gray-200" aria-label="Sidebar">
      ...
      <footer className="bg-white border-t border-gray-200">
        <div className="px-6 py-4 flex justify-between items-center text-sm text-gray-600">
          <div className="flex gap-6">
            ...
            <button className="hover:text-gray-900">Legal</button>
          </div>
